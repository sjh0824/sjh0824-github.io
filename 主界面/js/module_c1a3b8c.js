define("common:widget/userbar-new/userbar-new.js", function (e) {
    function o() {
        ...
        s("#userbar-logout").attr("href", "http://passport.baidu.com/?logout&aid=7&u=" + escape(location.href)).mousedown(function () {
            r.send({url: location.href, type: "2046", action: "logout"})
        });
        ...
        t.length && r.send({type: 2030, pv_from: "usrbar"}), new i("user-name", "username-sublist", {top: 10})
    }
    ...
    function t() {
        ...
        s.sio(e).callByBrowser(function () {
            if (window.redmsg && !(redmsg.length < 1)) {
                ...
                s("#baidu-msg").html('<a title="\u79c1\u4fe1" href="http://msg.baidu.com" target="_blank">' + e + "</a>"), n.fire("userbar.reposition", {waiting: !1})
            }
        })
    }

    function i(e, o, t) {
        var i = this, r = s("#" + e), a = s("#" + o);
        i.timeout = 0, r.mouseover(function () {
            clearTimeout(i.timeout);
            s(window).width(), s("#userbar").outerWidth(), s(this).position();
            s.isNumber(t.right) && (t.left = r.outerWidth() - a.width() - t.right), a.css({top: t.top}).show(), n.fire("userbar.show", {waiting: !0})
        }).mouseout(function () {
            i.timeout = setTimeout(function () {
                a.hide(), clearTimeout(i.timeoutId), n.fire("userbar.hide", {waiting: !1})
            }, 100)
        }), a.mouseover(function () {
            clearTimeout(i.timeout), a.show(), n.fire("userbar.show", {waiting: !0})
        }).mouseout(function () {
            r.mouseout()
    ...
    var s = e("common:widget/js/util/tangram/tangram.js"), n = e("common:widget/js/util/event/event.js"), r = (e("common:widget/js/logic/login/login.js"), e("common:widget/js/util/log/log.js")), a = e("common:widget/js/util/store/store.js");
    n.on("common.userbarMsgNum", function (e, o) {
        o > 99 && (o = "99+");
        var t = s("#userbar-msg"), i = t.find(".i-msg"), n = t.find(".orange-num");
        0 == o ? (n.html("<i></i>"), i.hide()) : (n.html("(<i>" + o + "</i>)"), i.show())
    }), s(function () {
        "1" == F.context("user").isLogin ? t() : (a.remove("ikmsg_data"), a.remove("ikmsg_time"), s.cookie.remove("msgGuide", {path: "/"}), s.cookie.remove("msgGuideStep", {path: "/"}), s.cookie.get("IK_PASS") && s.cookie.remove("IK_PASS", {path: "/"})), e.async("common:widget/js/logic/msg-new/msg-new.js", function (e) {
            if (1 == F.context("user").isLogin) {
                var o = s("#userbar"), t = o.offset().left, i = s("#userbar #userbar-msg"), n = i.offset().left;
                e.init({position: {top: 30, left: n - t - 346 + 3 * s("#userbar-msg").width() / 4}, commonUserbar: 1})
            } else e.init()
        })
    }), o(), s("#baidu-msg").on("click", function (e) {
        try {
            r.send({page: "all", type: 2060, action: "click", area: "baidu-msg"})
        } catch (e) {
            "undefined" != typeof alog && alog("exception.fire", "catch", {
                msg: e.message,
                path: "common:widget/userbar-new/userbar-new.js",
...
define("common:widget/menu/menu.js", function (n, e) {
    var o = n("common:widget/js/util/tangram/tangram.js"), t = o("#j-nav-menu-container"), i = t.find(".nav-show-control");
    e.init = function () {
        function n() {
            o = setTimeout(function () {
                i.css({overflow: "visible"}).addClass("nav-show-control-show")
            }, 100)
        }

        function e() {
            clearTimeout(o), i.css({overflow: "hidden"}).removeClass("nav-show-control-show")
        }
...
define("common:widget/menu-old/menu-old.js", function (e, n, o) {
    var s = e("common:widget/lib/jquery/jquery.js"), t = (e("common:widget/js/util/log/log.js"), e("common:widget/js/util/event/event.js"));
...
define("common:widget/bottom-ask/bottom-ask.js", function (o) {
    var t = o("common:widget/js/util/tangram/tangram.js"), a = o("common:widget/js/util/event/event.js"), n = o("common:widget/js/util/log/log.js"), e = cmsShowed = numShowed = !1;
    a.on("cmsMsg.show", function () {
        cmsShowed = !0, c()
    });
    var s = function () {
        var o = 12797381, a = t(".wgt-bottom-ask .bottom-ask-num");
        ...
        }), e = !0) : c(), 6 == t.browser.ie && t(".wgt-bottom-ask").css({top: t(window).scrollTop() + t(window).height() - t(".wgt-bottom-ask").height()}))
    }, c = function () {
    ...
    }), n.addKey({bottom_ask: 1}), t(".wgt-bottom-ask .bottom-ask-btn").on("click submit", function (o) {
        try {
            n.send({
                type: 2031,
                action: "click",
...
define("common:widget/js/ui/base/base.js", function (e, t, n) {
    ...
    var o = e("common:widget/lib/jquery/jquery.js"), s = e("common:widget/js/util/event/event.js");
    n.exports = i
});
;
...
define("common:widget/js/util/tangram/browser.js", function (e, t) {
    ...
    t.opera = v, function () {
        var e = navigator.userAgent, i = /(\d+\.\d)?(?:\.\d)?\s+safari\/?(\d+\.\d+)?/i.test(e) && !/chrome/i.test(e) ? +(RegExp.$1 || RegExp.$2) : void 0;
        t.safari = i
    }()
});
;
...
define("common:widget/js/util/tangram/cookie.js", function (e, n) {
    var t = function (e) {
        ...
        if (t(e)) {
            var n = new RegExp("(^| )" + e + "=([^;]*)(;|$)"), o = n.exec(document.cookie);
...
define("common:widget/js/util/tangram/chain.js", function (n, t, r) {
    ...
    r.exports = function (n) {
        var t = function (r) {
            var u = e.type(r), a = "object" == u || "array" == u ? r : n && new n(r) || {};
...
define("common:widget/js/util/tangram/number.js", function (n, t, r) {
    var a = n("common:widget/js/util/tangram/chain.js"), e = r.exports = a(Number);
    e.comma = function (n, t) {
        return (!t || 1 > t) && (t = 3), n = String(n).split("."), n[0] = n[0].replace(new RegExp("(\\d)(?=(\\d{" + t + "})+$)", "ig"), "$1,"), n.join(".")
    }, e.pad = function (n, t) {
        var r = "", a = 0 > n, e = String(Math.abs(n));
...
define("common:widget/js/util/tangram/string.js", function (r, e, t) {
    var n = (r("common:widget/lib/jquery/jquery.js"), r("common:widget/js/util/tangram/chain.js")), a = t.exports = n(String), c = function (r) {
    ...
    a.escapeReg = i;
    var f = function (r, e) {
        var t = Array.prototype.slice.call(arguments, 1), n = Object.prototype.toString;
    ...
    a.format = u, function () {
        var r = /^\#[\da-f]{6}$/i, t = /^rgb\((\d+), (\d+), (\d+)\)$/, n = {
            ...
            if (/^\#[\da-f]{3}$/.test(e)) {
                var o = e.charAt(1), i = e.charAt(2), f = e.charAt(3);
                return "#" + o + o + i + i + f + f
            }
            return n[e] ? n[e] : ""
        };
    ...
    a.toHalfWidth = d;
    var h = new RegExp("(^[\\s\\t\\xa0\\u3000]+)|([\\u3000\\xa0\\s\\t]+$)", "g"), v = function (r) {
...
define("common:widget/js/util/tangram/date.js", function (t, e) {
    var n = t("common:widget/js/util/tangram/number.js"), g = function (t, e) {
        function g(t, n) {
            e = e.replace(t, n)
        }
        ...
        var a = t.getFullYear(), i = t.getMonth() + 1, s = t.getDate(), o = t.getHours(), u = t.getMinutes(), d = t.getSeconds();
    ...
    var r = function (t) {
        ...
        if ("string" == typeof t) {
            if (e.test(t) || isNaN(Date.parse(t))) {
                var n = t.split(/ |T/), g = n.length > 1 ? n[1].split(/[^\d]/) : [0, 0, 0], r = n[0].split(/[^\d]/);
...
define("common:widget/js/util/tangram/object.js", function (e, r) {
    ...
    r.isPlain = n.isPlainObject, r.isArray = n.isArray, r.clone = function (e) {
        ...
        var e = Object.prototype.hasOwnProperty, r = !{toString: null}.propertyIsEnumerable("toString"), t = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"], n = t.length;
        return function (o) {
            ...
            if (r)for (var c = 0; n > c; c++)e.call(o, t[c]) && i.push(t[c]);
            return i
        }
    }(), r.keys = Object.keys;
    var o = function (e) {
    ...
    var i = function (e, r, n) {
        var o, i = 0, a = n || {}, c = a.overwrite, u = a.whiteList, s = a.recursive;
        if (u && u.length)for (o = u.length; o > i; ++i)t(e, r, u[i], c, s); else for (i in r)t(e, r, i, c, s);
        return e
    };
    r.merge = i
});
...
define("common:widget/js/util/tangram/array.js", function (r, t, e) {
    var n = r("common:widget/lib/jquery/jquery.js"), o = r("common:widget/js/util/tangram/object.js"), i = r("common:widget/js/util/tangram/chain.js"), a = e.exports = i(Array);
    Array.prototype.indexOf || (Array.prototype.indexOf = function (r) {
        "use strict";
        if (null == this)throw new TypeError;
        var t, e, n = Object(this), o = n.length >>> 0;
        if (0 === o)return -1;
        if (t = 0, arguments.length > 1 && (t = Number(arguments[1]), t != t ? t = 0 : 0 != t && 1 / 0 != t && t != -1 / 0 && (t = (t > 0 || -1) * Math.floor(Math.abs(t)))), t >= o)return -1;
        for (e = t >= 0 ? t : Math.max(o - Math.abs(t), 0); o > e; e++)if (e in n && n[e] === r)return e;
        return -1
    ...
    a.empty = f, Array.prototype.every || (Array.prototype.every = function (r) {
        ...
        for (o = arguments[1], n = 0; e > n; n++)if (n in t && !r.call(o, t[n], n, t))return !1;
        return !0
    ...
    var u = function (r, t) {
        var e, n, o = r.length;
        if ("function" == typeof t)for (n = 0; o > n; n++)if (e = r[n], !0 === t.call(r, e, n))return e;
        return null
    };
    a.find = u;
    var p = function (r, t) {
    ...
    a.hash = p, Array.prototype.lastIndexOf || (Array.prototype.lastIndexOf = function (r) {
        ...
        var t, e, n = Object(this), o = n.length >>> 0;
        if (0 === o)return -1;
        for (t = o, arguments.length > 1 && (t = Number(arguments[1]), t != t ? t = 0 : 0 != t && t != 1 / 0 && t != -(1 / 0) && (t = (t > 0 || -1) * Math.floor(Math.abs(t)))), e = t >= 0 ? Math.min(t, o - 1) : o - Math.abs(t); e >= 0; e--)if (e in n && n[e] === r)return e;
        return -1
    ...
    a.removeAt = c, Array.prototype.some || (Array.prototype.some = function (r) {
        ...
        var t, e, n = Object(this), o = n.length >>> 0;
        if ("function" != typeof r)throw new TypeError;
        for (t = arguments[1], e = 0; o > e; e++)if (e in n && r.call(t, n[e], e, n))return !0;
        return !1
    }), a.some = function (r, t, e) {
        Array.prototype.some.apply(r, [t, e])
    };
    var s = function (r, t) {
        var e, n, o = r.length, i = r.slice(0);
        for ("function" != typeof t && (t = function (r, t) {
            return r === t
        }); --o > 0;)for (n = i[o], e = o; e--;)if (t(n, i[e])) {
            i.splice(o, 1);
            break
        }
        return i
...
define("common:widget/js/util/tangram/sio.js", function (a, r, o) {
    var n = a("common:widget/lib/jquery/jquery.js"), t = a("common:widget/js/util/tangram/chain.js"), c = o.exports = t();
    ...
    var e = function (a) {
        var r = new Image, o = "tangram_sio_log_" + Math.floor(2147483648 * Math.random()).toString(36);
...
define("common:widget/js/util/tangram/url.js", function (n, r) {
    var e = n("common:widget/lib/jquery/jquery.js"), t = n("common:widget/js/util/tangram/string.js"), u = function (n) {
    ...
    r.escapeSymbol = u;
    var i = function (n, r) {
        var e = new RegExp("(^|&|\\?|#)" + t.escapeReg(r) + "=([^&#]*)(&|$|#)", ""), u = n.match(e);
        return u ? u[2] : null
    };
    r.getQueryValue = i;
    var o = function (n, r) {
        ...
        return e.each(n, function (n, r) {
            if (e.isArray(r))for (t = r.length; t--;)i.push(n + "=" + o(r[t], n)); else i.push(n + "=" + o(r, n))
        }), i.join("&")
    };
    r.jsonToQuery = o;
    var s = function (n) {
...
define("common:widget/js/util/tangram/swf.js", function (e, a) {
    var t = e("common:widget/lib/jquery/jquery.js"), r = e("common:widget/js/util/tangram/browser.js"), i = e("common:widget/js/util/tangram/array.js"), n = e("common:widget/js/util/tangram/string.js"), s = function (e) {
        var a, n = document[e];
    ...
    var o = function (e, a, t) {
        var r, i = this, n = this._flash = s(e);
    ...
    a.Proxy = o, o.prototype.getFlash = function () {
        ...
        try {
            var a = this.getFlash(), t = Array.prototype.slice.call(arguments);
    ...
    var l = function () {
        ...
        } else if (window.ActiveXObject && !window.opera)for (var t = 12; t >= 2; t--)try {
    ...
    var c = function (e) {
        e = e || {};
        var a, t, r, i, s, o, c = l, d = e.ver || "6.0.0", p = {}, u = n.encodeHTML;
        for (i in e)p[i] = e[i];
        if (e = p, !c)return "";
        for (c = c.split("."), d = d.split("."), r = 0; 3 > r && (a = parseInt(c[r], 10), t = parseInt(d[r], 10), !(a > t)); r++)if (t > a)return "";
        var v = e.vars, f = ["classid", "codebase", "id", "width", "height", "align"];
        if (e.align = e.align || "middle", e.classid = "clsid:d27cdb6e-ae6d-11cf-96b8-444553540000", e.codebase = "http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0", e.movie = e.url || "", delete e.vars, delete e.url, "string" == typeof v)e.flashvars = v; else {
            var h = [];
...
define("common:widget/js/util/tangram/tangram.js", function (t, e, n) {
    var r = n.exports = t("common:widget/lib/jquery/jquery.js"), o = t("common:widget/js/util/event/event.js");
...
define("common:widget/js/util/log/log.js", function (o, t) {
    ...
    function n(o) {
        var t = "IK_LOG_SESSION", e = a.cookie.get(t);
        if (e && ("pv" == o.action || "entrance" == o.action)) {
            if (!document.referrer)return a.cookie.remove(t, {path: "/"}), a.cookie.remove(t + "_STEP", {path: "/"}), void a.cookie.remove(t + "_LAST_URL", {path: "/"});
            var n = a.cookie.get(t + "_STEP"), i = a.cookie.get(t + "_LAST_URL"), r = location.href;
            i != r && (n = parseInt(n, 10) + 1, o.step = n, o.sessionid = e, a.cookie.set(t + "_STEP", n, {path: "/"}), a.cookie.set(t + "_LAST_URL", r, {path: "/"}))
        }
    }

    var a = o("common:widget/js/util/tangram/tangram.js");
    _globalOptions = {}, t.log = function (o) {
        var t = new Image, e = "bd_iknow_log_" + Math.floor(2147483648 * Math.random()).toString(36);
        window[e] = t, t.onload = t.onerror = t.onabort = function () {
            t.onload = t.onerror = t.onabort = null, window[e] = null, t = null
        }, t.src = o
    }, t.send = function (o) {
        var e = "http://nsclick.baidu.com/v.gif?", i = {pid: 102, url: location.href};
        ...
        var e = a.extend({append: !1, action: "global", separator: ","}, t || {});
        ...
        try {
            var e = a.extend({query: "", action: "click", target: "a"}, o || {});
            if (!e.query)return;
            var n = e.query;
        ...
        o = o || +new Date, a.cookie.set(t, o, {path: "/"}), a.cookie.set(t + "_STEP", 0, {path: "/"})
    }
});
;
define("common:widget/js/util/form/form.js", function (n, t, i) {
    var e = n("common:widget/lib/jquery/jquery.js"), o = function (n) {
        var t = this, i = e({});
        e.extend(t, {
            guid: e.guid++, on: function (n, t) {
                i.on(n, t)
            }, fire: function (n, t) {
                i.trigger(n, t)
            }, un: function (n, t) {
...
define("common:widget/js/util/store/store.js", function (e, t, n) {
    ...
    var a, u = e("common:widget/js/util/tangram/tangram.js"), c = {}, s = window, l = s.document, f = "localStorage", d = "globalStorage", m = "__storejs__";
    if (c.disabled = !1, c.set = function () {
        }, c.get = function () {
        }, c.remove = function () {
        }, c.clear = function () {
        }, c.transact = function (e, t) {
            var n = c.get(e);
...
define("common:widget/js/util/template/template.js", function (e, n, t) {
    ...
    a.cache = {}, a.LEFT_DELIMITER = a.LEFT_DELIMITER || "<%", a.RIGHT_DELIMITER = a.RIGHT_DELIMITER || "%>", a.ESCAPE = !0, a._encodeHTML = function (e) {
        ...
        var n = a.LEFT_DELIMITER, t = a.RIGHT_DELIMITER, r = a._encodeReg(n), p = a._encodeReg(t);
        return e = String(e).replace(new RegExp("(" + r + "[^" + p + "]*)//.*\n", "g"), "$1").replace(new RegExp("<!--.*?-->", "g"), "").replace(new RegExp(r + "\\*.*?\\*" + p, "g"), "").replace(new RegExp("[\\r\\t\\n]", "g"), "").replace(new RegExp(r + "(?:(?!" + p + ")[\\s\\S])*" + p + "|((?:(?!" + r + ")[\\s\\S])+)", "g"), function (e, n) {
            var t = "";
            if (n)for (t = n.replace(/\\/g, "&#92;").replace(/'/g, "&#39;"); /<[^<]*?&#39;[^<]*?>/g.test(t);)t = t.replace(/(<[^<]*?)&#39;([^<]*?>)/g, "$1\r$2"); else t = e;
            return t
...
define("common:widget/js/util/visibility/visibility.js", function (i, e, n) {
    var t = i("common:widget/lib/jquery/jquery.js"), o = i("common:widget/js/util/event/event.js"), d = {};
    o.create(d);
    var c = "hidden", m = function () {
...
define("common:widget/js/util/add-stylesheets/add-stylesheets.js", function (e, t, s) {
    ...
    s.exports = function (e) {
        if ("object" == n.type(e) && !n.isEmptyObject(e)) {
            ...
            if (document.createStyleSheet)document.createStyleSheet().cssText = t.join(""); else {
...
define("common:widget/js/util/countdown/countdown.js", function (t, n, i) {
    ...
    var r = t("common:widget/js/util/tangram/tangram.js"), a = t("common:widget/js/ui/base/base.js"), e = a(function (t) {
        var n = this;
...
define("common:widget/js/util/img-resize/img-resize.js", function (i, t, r) {
    function e(i, t, r, e, a) {
        return o(i).each(function () {
            if (o(this).is("img")) {
                var i = o(this).hide(), c = t || i.attr("width"), u = r || i.attr("height"), g = a || i.attr("align") || "center", d = i.attr("res") || i.attr("src"), f = "img_" + ++o.guid;
                if (e = o.isFunction(e) ? e : function () {
                        this.remove()
                    }, h[d])return i.css(s(h[d], c, u, g)).attr({src: h[d].src}).show();
                var m = new Image;
                window[f] = m, m.onload = function () {
                    h[d] = {width: this.width, height: this.height, src: this.src};
                    var t = i.attr("id") || f;
    ...
    function s(i, t, r, e) {
        var n = i.height, s = i.width;
        if (s > 0 && n > 0) {
            var h = Math.min(t / s, r / n);
            h = h > 1 ? 1 : h;
            var a = {width: s * h, height: n * h};
            return "center" == e && o.extend(a, {marginLeft: (t - s * h) / 2, marginTop: (r - n * h) / 2}), a
        }
        return {}
    }

    var o = i("common:widget/lib/jquery/jquery.js"), h = {};
    o.fn.imgResize = function (i, t, r, n) {
        return e(this, i, t, r, n)
    }, r.exports = {resize: e, getSize: s}
});
;
...
define("common:widget/js/util/tangram/timeFormater.js", function (e, t) {
    ...
    var u = e("common:widget/js/util/tangram/number.js").pad, i = e("common:widget/js/util/num2chinese/num2chinese.js");
    t.build = function (e) {
        var t;
        switch (typeof e) {
            case"number":
                ...
                break;
            case"string":
                if (Number(e))t = arguments.callee(parseInt(e)); else {
        ...
        for (var a = Math.abs(t.getTime() - e.getTime()), i = [{pattern: /d+/g, rate: 864e5}, {
            pattern: /h+/g,
            rate: 36e5
        }, {pattern: /m+/g, rate: 6e4}, {pattern: /s+/g, rate: 1e3}, {
            pattern: /f+/g,
            rate: 1
        }], s = 0; s < i.length; ++s) {
            i[s].value = a;
...
define("common:widget/js/ui/dialog/dialog.js", function (t, e, i) {
    var n = t("common:widget/lib/jquery/jquery.js"), o = t("common:widget/js/util/event/event.js"), s = t("common:widget/js/ui/base/base.js"), a = t("common:widget/js/util/tangram/browser.js");
    ...
    var c = {}, l = s().extend({
        init: function (t) {
            try {
                ...
                }), e.instance = t.target ? n(t.target).dialog(t) : n("<div>", {id: "ik-dlg-" + e.guid}).html(t.content).dialog(t), n.isArray(t.buttons) && e.customBttons(t.buttons), e.instance.next().css("text-align", t.btnAlign), t.autoDispose && e.instance.on("dialogclose", function () {
            ...
            var e = this, i = this.instance.next().children("div"), o = i.find("button");
            n(t).each(function (t) {
                var o = this;
...
define("common:widget/js/ui/suggestion/suggestion.js", function (e, t, i) {
    var o = e("common:widget/js/util/tangram/tangram.js"), n = (e("common:widget/lib/jquery.ui/jquery.ui.autocomplete.js"), e("common:widget/js/ui/base/base.js")), a = {};
    baidu = "undefined" == typeof baidu ? {} : baidu, i.exports = n(function () {
        ...
        init: function () {
            ...
            var e = this, t = e.checkDisabled(), i = o.trim(o(e.target).val()), n = e.url || "http://nssug.baidu.com/su?wd=#word#&prod=zhidao";
...
define("common:widget/js/ui/lazyload/lazyload.js", function (a) {
    ...
    o.fn.lazyload = function (a) {
        ...
        var e = o.extend({threshold: 100, effect: "show", appear: null, load: null}, a), i = this;
...
define("common:widget/js/ui/tip/tip.js", function (t, i, e) {
    var o = t("common:widget/lib/jquery/jquery.js"), s = t("common:widget/js/ui/base/base.js");
    t("common:widget/lib/jquery.ui/jquery.ui.tooltip.js"), e.exports = s(function (t) {
        var i = this;
        i.position = o.extend({
            my: "left top", at: "left bottom+10", collision: "none", using: function (e, s) {
        ...
        init: function (t) {
            try {
                ...
                }), i.instance = i.target.data("ui-tooltip"), i.target.tooltip("open", {target: i.instance.element}), i._status = "show", t.autoDisplay === !1 && this.close()
            } catch (e) {
                "undefined" != typeof alog && alog("exception.fire", "catch", {
                    msg: e.message,
                    path: "common:widget/js/ui/tip/tip.js",
            ...
            var t = this.target;
            t.attr("title") || t.attr("title", ""), t.tooltip("open", {target: this.instance.element}), this._status = "show", this.fire("show")
        }, show: function () {
...
define("common:widget/js/ui/carousel/carousel.js", function (i, e, t) {
    var s = i("common:widget/lib/jquery/jquery.js"), n = i("common:widget/js/ui/base/base.js"), a = n().extend({
        init: function (i) {
            try {
            ...
            try {
                var i = this, e = "horizontal" == i.options.direction ? "width" : "height", t = "horizontal" == i.options.direction ? "left" : "top", n = "horizontal" == i.options.direction ? "top" : "left";
            ...
            var t = this, n = t.setActiveItems(), a = "horizontal" == t.options.direction ? "left" : "top", o = t.activeIndex + ("next" == i ? t.options.viewSize : -1);
            o = (t.$items.size() + o) % t.$items.size();
            var c = s(n["next" == i ? 0 : t.options.viewSize - 1]), r = t.$items.eq(o);
            if ("experts" == t.options.serviceItem) {
                var o = r.attr("index"), l = t.$items.size();
...
define("common:widget/js/ui/pie/pie.js", function (t, e, a) {
    function s(t) {
        this.args = i.extend({pieR: 100, slices: [{percent: 1}]}, t), i.each(this.args.slices, function (t, e) {
        ...
        this.getPie = {
            svg: function () {
                ...
                return i.each(e.args.slices, function (t, o) {
                    g.svg.createElement("path").attr({d: g.svg.getSectorPath(s, o.angle, e.args.pieR, e.args.donutR)}).css({
                        fill: o.color || r(t),
    ...
    var i = t("common:widget/js/util/tangram/tangram.js"), n = t("common:widget/js/util/add-stylesheets/add-stylesheets.js");
    i.browser.ie < 9 && !document.namespaces.v && (document.namespaces.add("v", "urn:schemas-microsoft-com:vml"), n({"v\\:shape,v\\:group": "behavior:url(#default#VML);display:inline-block"}));
    var g = {
        svg: {
            createElement: function (t) {
                ...
                var r = {cos: Math.cos(t), sin: Math.sin(t)}, o = {cos: Math.cos(t + e), sin: Math.sin(t + e)};
            ...
            createElement: function (t) {
                ...
                var r = t * Math.PI / 180, o = {cos: Math.cos(r), sin: Math.sin(r)};
    ...
    o.animate = function () {
        var t = this, e = t.args.animation;
        i({aniStep: 0}).animate({aniStep: 1}, i.extend(!0, {}, e, {
            step: function (a) {
        ...
        constructor: o, getHTML: function () {
            var t = this.getNode();
...
define("common:widget/js/logic/search-box/search-box.js", function (e, t, o) {
    function a() {
        var e = location.pathname, t = "/" == e ? "home" : e.match(/\w+/)[0];
        return new RegExp("\\|" + t + "\\|").test("|search|question|home|browse|") ? t : "other"
    }

    function n(e) {
        var t = {
            "http://news.baidu.com/": {query: "ns?cl=2&rn=20&tn=news&t=1&word=#{0}"},
            "http://www.baidu.com/": {query: "s?cl=3&wd=#{0}"},
            "http://tieba.baidu.com/": {query: "f?kw=#{0}&t=4"},
            "http://music.baidu.com/": {query: "search?fr=zhidao&key=#{0}"},
            "http://image.baidu.com/": {query: "i?tn=baiduimage&ct=201326592&lm=-1&cl=2&word=#{0}&t=3"},
            "http://v.baidu.com/": {query: "v?ct=301989888&rn=20&pn=0&db=0&s=22&word=#{0}"},
            "http://map.baidu.com/": {query: "m?word=#{0}&fr=map007", encode: !0},
            "http://baike.baidu.com/": {query: "searchword/?word=#{0}&pic=1"},
            "http://wenku.baidu.com/": {query: "search?word=#{0}&lm=0&od=0"},
            "http://jingyan.baidu.com/": {query: "search?word=#{0}&fr=zhidao", encode: !0}
        }, o = i.trim(e);
        i(".search-box .channel a").each(function () {
            var e = "http://" + this.hostname + "/";
            if ("" != o) {
                if (t[e]) {
                    var a = t[e], n = a.encode ? encodeURIComponent(o) : o;
    ...
    var i = e("common:widget/js/util/tangram/tangram.js"), r = e("common:widget/js/ui/suggestion/suggestion.js"), c = e("common:widget/js/util/event/event.js"), s = e("common:widget/js/util/form/form.js"), m = e("common:widget/js/util/log/log.js"), u = e("common:widget/js/ui/dialog/dialog.js");
    e("common:widget/lib/jquery.placeholder/jquery.placeholder.js");
    var h = (new r({
        target: "#kw", beforeinit: function () {
            try {
            ...
            var e = i(this.target).autocomplete("widget"), t = i.trim(i(this.target).val());
            ...
            var e = this, t = i(e.target).autocomplete("widget");
            ...
            d.val(t.item.value), c.fire("searchBox.addLog", {f: "sug"}), o.exports.search(d)
        }
    }), {lm: 0, rn: 10, pn: 0, fr: "search", ie: "gbk"}), d = i("#kw"), l = i.json.parse(F.context("defaultQuery"));
    m.init({type: 8888, action: "click", query: ".channel"}), i("#search-form").submit(function (e) {
        m.send({type: 2014, pms: "newqb", action: "searchbtn"}), e.preventDefault(), o.exports.search(d)
    }), i("#ask-btn").click(function (e) {
        try {
            m.send({type: 2014, pms: "newqb", action: "askbtn"}), e.preventDefault(), o.exports.ask(d)
        } catch (e) {
            "undefined" != typeof alog && alog("exception.fire", "catch", {
                msg: e.message,
                path: "common:widget/js/logic/search-box/search-box.js",
        ...
        e = i(e);
        var t = !l || e.val() != l.title && e.val() != l.value ? e.val() : "", o = new s({
            method: "get",
            action: "/new",
            input: {word: t, ie: "GBK"}
        });
    ...
    c.on("searchBox.addLog", function (e, t) {
        ...
        var n = new s({method: "get", action: "/search", input: o});
        setTimeout(function () {
            n.submit()
        }, 60)
        ...
        u.alert(o, {
            ...
            autoDispose: !0,
            buttons: [{
                text: "\u7ee7\u7eed\u641c\u7d22", click: function () {
                    try {
                        var e = i.string(i("#search-empty-input").val()).trim();
                        "" != e && c.fire("searchBox.searchAction", {params: {word: e, fr: t.fr, lm: t.lm || 0}})
                    } catch (o) {
                        "undefined" != typeof alog && alog("exception.fire", "catch", {
                            msg: o.message,
                            path: "common:widget/js/logic/search-box/search-box.js",
            ...
            open: function () {
                ...
                var o = i("<span/>").html(t.textBottom || "").css({"padding-left": "10px", "font-size": "12px"});
                i(e).append(o)
            }
        })
    })
...
define("common:widget/js/logic/authcode/authcode.js", function (t, e, a) {
    var i = t("common:widget/lib/jquery/jquery.js"), o = t("common:widget/js/ui/base/base.js"), n = t("common:widget/js/ui/dialog/dialog.js"), u = t("common:widget/js/ui/tip/tip.js"), c = o().extend({
        init: function () {
            try {
                var t = this;
            ...
            var t = this, e = i('<div class="ik-authcode-wrapper"></div>');
            e.append('<label class="ik-authcode-label">\u9a8c\u8bc1\u7801\uff1a</label>').append('<input class="ik-authcode-input" type="text" maxlength="4">').append('<img class="ik-authcode-img" src="other/about:blank" style="display: none; ">').append('<a class="ik-authcode-change" href="#" style="display: none; ">\u770b\u4e0d\u6e05\uff1f</a>').append('<div class="ik-authcode-error" style="display: none; ">\u9a8c\u8bc1\u7801\u9519\u8bef</div>'), t.className && e.addClass(t.className), t.container.append(e).show();
            var a = (t.getAuthElement("me._tip"), t.getAuthElement("error")), o = t.getAuthElement("input"), n = t.getAuthElement("img");
            ...
            try {
                var e = this, a = e._authUrl + "?from=" + e.from;
...
define("common:widget/js/logic/captcha/captcha.js", function (t, e, a) {
    var c = t("common:widget/lib/jquery/jquery.js"), i = t("common:widget/js/ui/base/base.js"), n = t("common:widget/js/ui/dialog/dialog.js"), s = t("common:widget/js/util/event/event.js"), d = i(function () {
        var t = this;
        ...
        init: function () {
            try {
                var t = this;
                t._initCaptcha({
                    url: t.url, from: t.from || "", type: t.type, callback: function () {
            ...
            try {
                var e = this, a = c.string("#{url}?from=#{from}&style=#{type}&t=").format(t) + (new Date).getTime();
                c.get(a, function (a) {
            ...
            return {vcode_str: this.vcode.vcodeStr, vcode: this._codeArr.join("")}
        }, change: function () {
            var t = this;
            t._initCaptcha({
                url: t.url, from: t.from || "", type: t.type, callback: function () {
            ...
            var a = c.string(e._styleSheetTpl).format({imgUrl: t.imgUrl, t: (new Date).getTime()});
            ...
            var t = this, e = new n({
                ...
                height: 340,
                autoDispose: !0,
                content: c.string(t._templateTpl).format({tip: t.tip})
            });
            this.dialog = e;
            var a = e.instance, i = a.find(".captcha-input dt"), s = a.find(".captcha-content-img"), d = a.find(".captcha-content-change"), r = a.find(".captcha-input dd");
            c.extend(t, {captchaInputs: r, captchaErrTip: a.find(".captcha-content-tip")}), i.click(function () {
                try {
                ...
                c(this).click(function (a) {
                    try {
                        if (a.preventDefault(), 0 == t._currIndex)t.captchaErrTip.text(t.tip).removeClass("f-red"); else if (4 == t._currIndex)return;
...
define("common:widget/js/logic/complain/complain.js", function (e, t, o) {
    ...
    var n = e("common:widget/js/util/tangram/tangram.js"), a = e("common:widget/js/util/event/event.js"), c = e("common:widget/js/ui/dialog/dialog.js"), l = e("common:widget/js/logic/submit/submit.js"), d = e("common:widget/js/logic/authcode/authcode.js");
    o.exports = function (e, t, o, a) {
        function s() {
            m.getAuthElement("input").css("border", "1px solid red")
        }

        var m, r = '<span style="width:78px;font-weight: bold;vertical-align: top;">\u7533\u8bc9\u7406\u7531\uff1a</span><textarea id="complain-dialog" cols="37" rows="5" maxlength="1000" style="width:290px;height:90px;border:1px solid #000;"></textarea>', g = {
            cm: 100043,
            qid: e,
            type: 100001
        }, p = {title: "\u77e5\u9053\u63d0\u793a", height: 290, width: 400, autoDispose: !0};
        !!t && n.extend(g, {aid: t, type: 100009}), "object" == n.type(a) && n.extend(g, a);
        var u = c.confirm(r, n.extend({
            type: "confirm", onaccept: function () {
                return 3 == o ? void i() : (g.appeal_reason = n.trim(n("#complain-dialog").val()), 2 == o && n.extend(g, {mode_type: "realtime"}), n.extend(g, m.getCode()), 4 != n.trim(g.vcode).length ? void s() : void new l({
                    params: g,
                    syncId: e,
                    beforeJump: i,
...
define("common:widget/js/logic/category/category.js", function (e, t, a) {
    var i = e("common:widget/lib/jquery/jquery.js"), n = e("common:widget/js/ui/base/base.js"), l = n(function () {
        var e = this;
        ...
        data: {}, init: function () {
            ...
            var e = this, t = {cid: 0, name: "", arrCid: [], arrName: []};
...
define("common:widget/js/logic/login/login.js", function (o, e) {
    ...
    var s = T = o("common:widget/js/util/tangram/tangram.js"), c = o("common:widget/js/util/event/event.js"), g = o("common:widget/js/util/uri/uri.js"), a = o("common:widget/js/ui/dialog/dialog.js"), r = null, u = !1, l = new Date, p = "http://passport.bdimg.com/passApi/js/uni_login_wrapper.js?cdnversion=" + l.getFullYear() + l.getMonth() + l.getDate() + l.getHours() + l.getMinutes(), f = "/api/loginInfo", h = {
    ...
    h.authsite = ["qzone", "tsina", "renren"], h.authsiteCfg = {
        ...
        h.onLoginSuccess = function (o) {
            c.fire("dialog.close"), c.fire("login.check", {
                sync: i && i.sync, isLogin: function (o) {
                    o.isFilter && c.fire("login.filter", {type: "set", filterInfo: o.isFilter}), n(o)
                }, noLogin: function () {
                }
            }), o.returnValue = !1
        ...
        e = e || {}, h.onLoginSuccess = e.isLogin || i, h.onLoginFailure = e.noLogin || n, s.ajax({
            ...
            success: function (o, e, i) {
                var n = s.json.parse(i.responseText), t = F.context("user") || {};
        ...
        function i() {
            ...
            c.on("setusername.update", function (e, i) {
                o && o.setSize({width: i.width, height: i.height})
            })
        }
        ...
        c.fire("login.check", {
            isLogin: function () {
                ...
                c.fire("login.log", {onLoginSuccess: i})
            }
        })
        ...
        if ("set" == e.type)T.cookie.set("IK_USER_FILTER", e.filterInfo.reason, {
            ...
            T.cookie.remove("IK_USER_FILTER", {path: "/"}), T.cookie.remove("IK_USER_FILTERI", {path: "/"}), T.cookie.remove("IK_USER_FILTERT", {path: "/"})
        }
        ...
        c.fire("login.filter", {type: "check"})
    }()
});
;
define("common:widget/js/logic/iask/iask.js", function (e, i, n) {
    var o = e("common:widget/js/util/tangram/tangram.js"), t = e("common:widget/js/ui/dialog/dialog.js"), a = e("common:widget/js/util/event/event.js");
        ...
        a.fire("login.check", {
            isLogin: function () {
                o.get("/iask/api/ikhelplimit?un=" + encodeURIComponent(e) + "&t=" + (new Date).getTime(), function (i) {
                    ...
                    if (n && 0 == n.status) {
                        var s = n.data, c = s.replyLimit, m = s.replyMaxNum, r = s.ifLogin, l = s.ifUsernameOK;
...
define("common:widget/js/logic/dom-ready/dom-ready.js", function (o, t) {
    function e(o) {
        i.ajax({
            url: "/s/toutu/questionnaire.js", dataType: "json", success: function (t) {
                if (t) {
                    var e = t.showUrl, i = t.url;
                    if (!e || "http://" === e || !i || "http://" === i)return void(o && o({url: ""}));
                    for (var n = window.location.pathname, a = e.split(" "), r = !1, s = 0, c = a.length; c > s; s++)if ("/" === a[s] && n === a[s] || "/" !== a[s] && -1 !== n.indexOf(a[s])) {
                        r = !0;
                        break
                    }
                    window.location.href === e || r ? o && o({url: i}) : o && o({url: ""})
                } else o && o({url: ""})
            }, error: function () {
                o && o({url: ""})
            }
    ...
    var i = o("common:widget/js/util/tangram/tangram.js"), n = o("common:widget/js/logic/jump-top/jump-top.js");
    t.init = function (o) {
        try {
            var t = location.pathname, a = o.img;
            try {
                e(function (e) {
                    n({
            ...
            if (window.console) {
                var c = console, l = i("#search-box .logo");
...
define("common:widget/js/logic/jump-top/jump-top.js", function (i, e, o) {
    ...
    var s = i("common:widget/lib/jquery/jquery.js"), a = (i("common:widget/js/util/log/log.js"), i("common:widget/js/ui/dialog/dialog.js"), ['<div class="jump-top">', '<a href="#" target="_self">\u8fd4\u56de\u9876\u90e8</a>', "</div>"].join("")), r = ['<div class="jump-profhelp">', '<a href="http://wpa.qq.com/msgrd?v=3&uin=2725326332&site=qq&menu=yes" target="_blank">\u5728\u7ebf\u5ba2\u670d</a>', "</div>"].join(""), d = ['<div class="jump-goto-mavin">', '<a href="/ihome/hangjia/index" target="_blank"><i></i><span>\u8fdb\u5165\u884c\u5bb6\u5de5\u4f5c\u5ba4<span></a>', "</div>"].join("");
    o.exports = function (i) {
        function e(e) {
            var o = s(window).scrollTop(), t = (6 == s.browser.ie ? o : 0) + s(window).height() - l.height() - i.offset[0] - 110, n = o > s(window).height() / 2 ? "visible" : "hidden";
            i.isFeedback || i.isProf || i.isMavin || i.isQuestionnaire ? l.find(".jump-top").css("visibility", n) : l.css("visibility", n), l.animate({top: t + "px"}, e || 0)
        }

        s.isPlainObject(i) || (i = {}), s.isArray(i.offset) || (i.offset = [0, 0]);
        var o = i.isFeedback ? n(i.feedbackPl) : i.isProf ? r : "", c = i.isQuestionnaire ? t(i.isQuestionnaire) : "", l = s("<div />").addClass("jump-top-box").css({right: i.offset[1] + 5 + "px"}).html([a, o, c, i.isMavin ? d : ""].join("")).appendTo(document.body);
        l.find(".jump-top a").click(function (i) {
            try {
                i.preventDefault(), s(s.browser.ie || s.browser.firefox ? document.documentElement : document.body).animate({scrollTop: "0px"}, 500)
            } catch (i) {
                "undefined" != typeof alog && alog("exception.fire", "catch", {
                    msg: i.message,
...
define("common:widget/js/logic/msg/msg.js", function (e, t) {
    function i(e, t) {
        if (D) {
            var o, a = d + 1e3 * h < (new Date).getTime() ? !0 : !1, r = !0, s = _.getLocalData();
    ...
    function o(e, t) {
        var i = t || !0, o = _.delLocalData(e);
        if (i && o.length > 0) {
            var n = {type: 10091 == o[0].type || 10092 == o[0].type ? 1009 : o[0].type, id: o[0].id, count: o[0].count};
            _.delServerData(n)
        }
    }
    ...
    function a() {
        ...
        if (0 != r("#userbar #user-name").size()) {
            var e, o = {}, n = location.pathname + location.search;
    ...
    var r = e("common:widget/js/util/tangram/tangram.js"), s = e("common:widget/js/ui/tip/tip.js"), l = e("common:widget/js/util/store/store.js"), c = e("common:widget/js/util/log/log.js"), g = e("common:widget/js/util/event/event.js"), m = e("common:widget/js/ui/dialog/dialog.js"), u = e("common:widget/js/util/visibility/visibility.js"), p = "http://msg.zhidao.baidu.com/", f = "/s/toutu/promotion.js", d = (new Date).getTime(), h = 180, v = 0, w = 3, y = !1, b = null, T = null, j = null, D = 0 != F.context("user").isLogin, k = "/uhome/msg/", x = "/uhome", L = document.title, C = {
        ...
        1009: {title: "{$n}\u4e2a\u56de\u7b54\u88ab\u91c7\u7eb3", url1: k + "event?fr=msg", url2: k + "event?fr=msg"},
        10091: {
            title: "{$n}\u4e2a\u56de\u7b54\u83b7\u5f97\u597d\u8bc4",
            url1: k + "event?fr=msg",
            url2: k + "event?fr=msg"
        ...
        1018: {title: "{$n}\u4e2a\u56de\u7b54\u88ab\u63a8\u8350", url1: k + "event?fr=msg", url2: k + "event?fr=msg"},
        1008: {
            title: "{$n}\u4e2a\u56de\u7b54\u8d5e\u540c",
        ...
        1005: {title: "{$n}\u4e2a\u56e2\u961f\u6c42\u52a9", url1: "/team", url2: "/team/view/{$tname}#question-3"},
        1012: {title: "{$n}\u4e2a\u65b0\u52a8\u6001", url1: k + "event?fr=msg", url2: k + "event?fr=msg"},
        1019: {title: "{$n}\u4e2a\u65b0\u901a\u77e5", url1: k + "sysmsg?fr=msg", url2: k + "sysmsg?fr=msg"},
        1020: {
            title: "{$n}\u4e2a\u56de\u7b54\u88ab\u63a8\u8350\u4e3a\u4f18\u8d28",
            url1: k + "event?fr=msg",
            url2: k + "event?fr=msg"
        ...
        cookieName: "IK_MSG_POPUP", getCms: function (e) {
            r.ajax({
            ...
            r.cookie.set($.cookieName, e.id, {expires: r.date.parse(e.endTime).getTime(), path: "/"})
            ...
            !e.imageUrl || "http://" === e.imageUrl || e.imageUrl.length < 17 || (T = new s({
                rightbottom: "popcms",
                width: 240,
                position: {my: "right-3 bottom-3", at: "right bottom"},
                ...
                try {
                    T.hide(), c.send("img" == e.target.nodeName.toLowerCase() ? {
                        ...
                        page: "bubble",
                        pos: "bubble-img"
                    } : r(e.target).hasClass("tip-close") ? {type: 2031, page: "bubble", pos: "bubble-close"} : {
                        type: 2031,
                        page: "bubble",
                        pos: "bubble-link"
                    })
            ...
            var t = r.date.parse(e.startTime), i = r.date.parse(e.endTime), o = r.cookie.get($.cookieName);
        ...
        getServerData: function (e) {
            ...
            i += "&cu=" + encodeURIComponent(F.context("user").name), e && (e.fr || e.poll) && (i += "&" + r.url.jsonToQuery(e)), r.sio(i).callByServer(function (i) {
                if (e && e.poll) {
                    ...
                    if (o && o.data && i) {
                        ...
                        c.send({type: 2031, page: "bubble", action: "poll", match: n})
                    }
                }
                t.refresh(i)
            })
            ...
            return {time: l.get("ikmsg_time") || 0, data: r.json.parse(l.get("ikmsg_data") || "null")}
        }, delLocalData: function (e) {
            var i = [], o = this.getLocalData();
            if (o && (o = o.data)) {
                if (o.actList)for (var n = 0; n < o.actList.length; n++)if (o.actList[n].type == e.type) {
            ...
            l.remove("ikmsg_data"), l.remove("ikmsg_time"), this.delServerData({type: "99999", count: 1})
            ...
            var i = [], o = [], n = [], a = this, l = 0;
            if (r.forEach(e, function (e, t) {
                    var a = C[e.type];
                    if (!(1008 == e.type && e.create_time < (new Date).getTime() / 1e3 - 864e5)) {
                        if (a) {
                            var r = a.title.replace("{$n}", '<span class="num">' + e.count + "</span>"), s = e.count > 1 ? a.url1 : a.url2.replace("{$qid}", e.qid).replace("{$aid}", e.aid);
            ...
            b || (b = new s({
                ...
                try {
                    var i = {}, o = e.target.nodeName.toLowerCase();
                    "i" == o ? (e.stopPropagation(), e.preventDefault(e), i.pos = "msg-del") : i.pos = "msg-title";
                    var n = r(e.target).closest("a"), a = n.attr("index");
                    a && (i.actType = a, i && c.send(r.extend(i, {
                        type: 2031,
                        page: "msg"
                    })), document.title = L, t.del({type: a}), -1 == n.attr("href").indexOf("time=") && (n[0].href += (-1 == n[0].href.indexOf("?") ? "?" : "&") + "time=" + (new Date).getTime())), 1008 == a && "i" == o && m.confirm("\u662f\u5426\u4e0d\u518d\u663e\u793a\u88ab\u8d5e\u540c\u6d88\u606f\uff1f", {
                        onaccept: function () {
    ...
    g.on("tip.resize", function () {
        if (b) {
            var e = r("#user-name"), t = b.getTipContainer(), i = r(t).find(".tip-arrow");
            if (!e || !t || z)return !1;
            var o = r(e).offset(), n = r(window).scrollTop();
    ...
    g.on("userbar.show", function (e, i) {
        ...
        init: a, show: _.showTip, hide: _.hideTip, del: o, resize: function () {
...
define("common:widget/js/logic/msg-new/msg-new.js", function (e, s, i) {
    function t(e) {
        ...
        s.size() || (s = f(p(b, {
            ...
            try {
                var e = f(this).parents("li"), s = (e.parent(".nav-msg-list"), "");
                s = f.json.stringify(1009 == e.data("type") && e.data("r-uniq-id") ? [{
                    srctype: e.data("type"),
                    uniq_id: e.data("uniq-id")
                }, {srctype: 1018, uniq_id: e.data("r-uniq-id")}] : [{
                    srctype: e.data("type"),
                    uniq_id: e.data("uniq-id")
                }]), f.post("/notice/close/batch", {close_list: s}, function (s) {
                    if (!s.errno) {
    ...
    function a() {
        ...
        e.next(".scrollbar-wp").remove(), new h({scrollWrapper: e.parent(), scrollContent: e, maxHeight: 266}).render()
    }

    function n(e) {
        var s = f(".nav-msg-list");
        f.get(N + (e || "ask"), {t: +new Date}, function (e) {
            if (0 == e.errno) {
    ...
    function o() {
        function e(e, s) {
            var i = s.all.unread;
            if (0 == i)e.find("i").remove(); else if (j != i) {
                var a = f("i", e);
        ...
        var s = f("#userbar-msg"), i = m(), a = !0, n = D + 1e3 * C < (new Date).getTime() ? !0 : !1;
    ...
    function m() {
        return {time: _.get("ikmsg_time") || 0, data: f.json.parse(_.get("ikmsg_data") || "null")}
    }
    ...
    var d, g, f = e("common:widget/js/util/tangram/tangram.js"), u = e("common:widget/js/ui/tip/tip.js"), p = e("common:widget/js/util/template/template.js"), h = (e("common:widget/js/util/log/log.js"), e("common:widget/js/ui/scrollbar/scrollbar.js")), v = e("common:widget/js/util/event/event.js"), _ = e("common:widget/js/util/store/store.js"), w = "/s/toutu/promotion.js", k = "http://muzhi.baidu.com", y = {
        ...
        cmsCookieName: "IK_MSG_POP", getCms: function (e) {
            f.ajax({
                url: e, dataType: "json", success: function (e) {
                    if (e) {
                        q.show(e, "cms");
            ...
            f.cookie.set(q.cmsCookieName, e.id, {expires: f.date.parse(e.endTime).getTime(), path: "/"})
        }, generateView: function (e) {
            var s = [];
            ...
            var s = f.date.parse(e.startTime), i = f.date.parse(e.endTime), t = f.cookie.get(q.cmsCookieName), a = !1;
            return 1 == e.enabled && t != e.id && (new Date).getTime() >= s.getTime() && (new Date).getTime() < i.getTime() && (a = !0), a
        }
    }, b = ['<div id="nav-msg-layout">', '<div class="nav-msg-tri"></div>', '<div class="nav-msg-menu">', '<a href="#" class="nav-msg-ask<#if(isNewAsk || (!isNewReply && !isNewSys)){#> active<#}#>" data-type="ask"><i></i><span>\u63d0\u95ee</span><#if(isNewAsk){#><s></s><#}#></a>', '<a href="#" class="nav-msg-answer<#if(!isNewAsk && isNewReply){#> active<#}#>" data-type="reply"><i></i><span>\u56de\u7b54</span><#if(isNewReply){#><s></s><#}#></a>', '<a href="#" class="nav-msg-sys<#if(!isNewAsk && !isNewReply && isNewSys){#> active<#}#>" data-type="sysmsg"><i></i><span>\u7cfb\u7edf</span><#if(isNewSys){#><s></s><#}#></a>', "</div>", '<div class="nav-msg-wrap"><ol class="nav-msg-list line"></ol></div>', '<div class="nav-msg-more">', '<a href="/ihome/notice/all" target="_blank" id="notice-all-clear"><i class="i-msg mr-5"></i><span>\u6240\u6709\u901a\u77e5</span></a>', "</div>", "</div>"].join(""), j = 0, T = !1, x = "/notice/get/count", N = "/notice/get/", D = (new Date).getTime(), C = 180;
...
define("common:widget/js/logic/submit/submit.js", function (e, o, t) {
    var a = e("common:widget/js/util/tangram/tangram.js"), r = e("common:widget/js/ui/base/base.js"), c = e("common:widget/js/ui/dialog/dialog.js"), n = e("common:widget/js/logic/ut/ut.js"), i = e("common:widget/js/util/event/event.js"), s = e("common:widget/js/util/form/form.js"), m = e("common:widget/js/logic/captcha/captcha.js"), d = e("common:widget/js/util/log/log.js"), l = r(function (o) {
        var t = this;
        ...
        var r = {
            ...
            jumpSubmit: function (e, o, r) {
                var c = {name: t.guid + "_FORM_NAME", id: t.guid + "_FORM_ID", action: "/submit/", method: "post"};
                c.action = "" != document.referrer ? "/submit/?cm=" + o.cm + "&fr=" + encodeURIComponent(document.referrer) : "/submit/?cm=" + o.cm, 1 == F.context("hasZhimaTag") && F.context("zhimaTagOpen") && (c.action += "&iszhima=1"), new s(a.extend(a.extend(c, r || {}), {input: o})).submit()
            },
            errorDeal: function (e, o) {
                var t = o && o.data || {info: "\u7f51\u7edc\u5f02\u5e38\u5566\uff1a\uff08\u8bf7\u91cd\u65b0\u63d0\u4ea4"}, n = o && o.errorNo;
                if (t && n && 10054 == n) {
                ...
                d.send({type: 2032, action: "submitError", errorNo: n})
            }
        };
        ...
        var l = function () {
            /\/submit\/(ajax|user)/.test(r.url) && F.context("user").stoken && (r.params.stoken = F.context("user").stoken), a.ajax(r.url, {
                ...
                success: function (o) {
                    if (r.syncId && (t.syncIdMap[r.syncId] = !1), o && "undefined" == typeof o.errorNo && (o.errorNo = o.errno), o && "undefined" == typeof o.data && (o.data = o), o && 0 == o.errorNo)r.captcha && r.captcha.dialog.close(), t.fire("beforeJump", o.data), r.hasJump && r.jumpSubmitDelay ? setTimeout(function () {
                    ...
                    }, r.jumpSubmitDelay) : r.hasJump && t.fire("jumpSubmit", o.data); else {
                        var n = o ? o.data : "";
                        ...
                        if (o && 12 == o.errorNo && 1 != n.reason && F.context("user").gradeIndex > 3) {
                            a(document).on("click", ".user-appeal-complain", function (o) {
                                try {
                                    o.preventDefault(), s.close(), e.async("common:widget/js/logic/complain/complain.js", function (e) {
                                        e("no-qid", null, null, {type: 100500})
                                    })
                                } catch (t) {
                                    "undefined" != typeof alog && alog("exception.fire", "catch", {
                                        msg: t.message,
                            ...
                            var i = '\u60a8\u7684\u8d26\u53f7\u8fdd\u53cd\u4e86<a href="http://help.baidu.com/question?prod_en=zhidao&class=154&id=851" target="_blank">\u77e5\u9053\u89c4\u8303</a>\uff0c\u5df2\u88ab' + (n.days > 0 ? "" : "\u6c38\u4e45") + "\u5c01\u7981\uff0c\u65e0\u6cd5\u8fdb\u884c\u4efb\u4f55\u64cd\u4f5c" + (n.days > 0 ? "\uff0c\u8fd8\u6709" + n.days + "\u5929\u89e3\u5c01" : "") + '\u3002\u5982\u679c\u60a8\u8ba4\u4e3a\u5224\u65ad\u6709\u8bef\uff0c\u8bf7<a href="javascript:;" class="user-appeal-complain">\u53d1\u8d77\u7533\u8bc9</a>\uff0c\u5e2e\u52a9\u6211\u4eec\u6301\u7eed\u6539\u8fdb\u3002', s = c.alert(i, {width: 400});
                            return
                        }
                        if (o && 13 == o.errorNo)return void t.errorCheck({
                            errorNo: 13, actCallback: function () {
        ...
        syncIdMap: {}, _init: function () {
            ...
            if (o.errorNo_Checked || (o.errorNo_Checked = {
                ...
                buttons: [{
                    text: o.errorNo_Checked[e.errorNo].act || "", click: function () {
                        try {
                    ...
                    text: o.errorNo_Checked[e.errorNo].cancel || "\u53d6\u6d88", click: function () {
                        try {
...
define("common:widget/js/logic/ut/ut.js", function (t, e, n) {
    function o(t) {
        var e = [t.x, t.y], n = m(this), o = g[this.id];
        if (o)o.hover || (o.hover = !0, o.count++); else {
            var i = n.position();
        ...
        o["mouse" + o.count] || (o["mouse" + o.count] = [], o["time" + o.count] = {start: +new Date}, g.ma.push(o["mouse" + o.count]), g.ea.push(this.id)), o["mouse" + o.count].push(e)
    }

    function i(t) {
        var e = [t.x, t.y], n = g[this.id];
        if (n && n.hover) {
    ...
    function h(t, e) {
        new f({method: "post", target: "iktssender", action: t, input: e}).submit().dispose()
    }

    var m = t("common:widget/lib/jquery/jquery.js"), f = t("common:widget/js/util/form/form.js"), d = +new Date, g = {
        ea: [],
        ma: []
    }, p = {}, l = !1, v = 0, j = +new Date, w = {};
    n.exports = {start: a, report: c, send: h}
});
;
...
define("common:widget/js/logic/sign-in/sign-in.js", function (e, n, i) {
    var t = e("common:widget/js/util/tangram/tangram.js"), s = e("common:widget/js/ui/base/base.js"), a = e("common:widget/js/ui/tip/tip.js"), o = e("common:widget/js/ui/dialog/dialog.js"), d = e("common:widget/js/logic/submit/submit.js"), c = e("common:widget/js/util/event/event.js"), r = e("common:widget/js/util/log/log.js"), l = e("common:widget/js/logic/authcode/authcode.js");
    e("common:widget/lib/jquery.ui/jquery.ui.datepicker.js"), c.on("short.dialog", function (e, n) {
        var i = ['<div class="short-content">', "<p>", n.content, "</p>", "</div>"].join(""), t = new o({
            content: i,
            autoDispose: !0,
            width: 300,
            height: 100,
    ...
    var g = s().extend({
        _initDialog: function () {
                ...
                window.dialogInstance ? window.dialogInstance.open() : window.dialogInstance = new o({
                    ...
                    open: function () {
                        t(".sign-in-dialog .close-layer").click(function () {
                            try {
                                e._removeRemedyTip();
                                var n = {type: 2014, action: "click", pos: "signin-dialog-close"};
                            ...
                            beforeShowDay: function (n) {
                                var i = t.parseJSON(F.context("sign-in").signinDays), s = lastMonth = futureDate = !1, a = [n.getFullYear(), n.getMonth() + 1, n.getDate()].join("/");
                ...
                t(".sign-in-dialog").delegate("#sign-in-btn", "click", function (n) {
                    try {
                        t(this).hasClass("done") ? r.send({
                            ...
                            isLogin: function () {
                                new d({
                                    url: "/submit/user", params: {cm: 100509}, beforeJump: function () {
                                        var n = t(".exp-text"), i = parseInt(n.css("top"));
                                        n.css({
                                            top: parseInt(i + 25),
                                            display: "block"
                                        }).animate({top: i}, 800, function () {
                                            setTimeout(function () {
                                                n.css("display", "none")
                                            }, 800)
                                        }), e._updateSignIn(), e._todayMonth()
                                    }, errorDeal: function (e, n) {
                                        c.fire("short.dialog", {content: n.errorMsg})
                                    }
                                })
                            }
                        }))
            ...
            var e = this, n = t(e.target).find(".ui-datepicker-today");
            ...
            try {
                var i = this, s = [7, 15, 30, 60], a = 0, o = 0, d = 0, c = 0, r = 0;
            ...
            var i = this, s = t(i.container).find(".bar-tip"), a = t(i.container).find(".empty-line");
            ...
            var n = this, i = "", s = ["", '\u4eca\u5929\u5df2\u7ecf\u7b7e\u5230\u5566<br/>\u7b54\u9898\u66f4\u53ef\u4ee5\u52a0\u901f\u6210\u957f\u54e6<i class="speed-up-desc cur-pointer"></i>', "\u8fde\u7eed\u7b7e\u5230<br/>\u8d62\u53d6\u8d22\u5bcc\u503c\u597d\u793c"];
            setTimeout(function () {
                t.get("/ihome/api/signInfo?t=" + (new Date).getTime(), function (a) {
                    a.errno || (a = a.data, t.object.each(a, function (e, n) {
                        ...
                        href: "/ihome",
                        target: "_blank"
                    }), t(".go-sign-in").text("\u5df2\u7b7e\u5230"), t(".signInTipAnimation").removeClass("signInTipAnimation"), t(".speed-up-tip").size() || t("<div/>").prop({"class": "speed-up-tip"}).appendTo(t(".sign-in-desc")), n._lightToday()), F.context("sign-in").noSignDays >= 1 && F.context("sign-in").noSignDays <= 3 ? 1 == F.context("sign-in").isSignIn && "\u5df2\u7b7e\u5230" != t(".go-sign-in").text() ? (i = s[1], setTimeout(function () {
            ...
            var e = this, n = t(e.target).find(".ui-datepicker-today"), i = t(e.target).find(".ui-datepicker-prev"), s = t(e.target).find(".ui-datepicker-next");
            ...
            t("#wealth-submit").hasClass("disabled") || (window.authDialog = new o({
                ...
                open: function () {
                    ...
                    t(".auth-dialog").find("#authcode-dialog").append(n), e = new l({
                        ...
                        url: "/api/vcode",
                        force: !0,
                        urlParams: {forceHit: 1}
                    }), t(".auth-dialog #auth-submit").click(function (n) {
                        try {
                            n.preventDefault();
                            var i = {cm: 100508, uflag: "sign_award"};
                            e && e.submitParam(i), c.fire("login.check", {
                                isLogin: function () {
                                    new d({
                                        url: "/submit/user", params: i, beforeJump: function (e, n) {
                                            F.context("sign-in").isSignIn = 1, F.context("sign-in").dayNum = n.day, t("#my-wealth").text(0), t("#wealth-submit").addClass("disabled"), authDialog.close(), c.fire("short.dialog", {content: "\u9886\u53d6\u6210\u529f\uff01"})
                                            ...
                                            switch (parseInt(i.errorNo)) {
                                                ...
                                                case 5:
                                                    ...
                                                    break;
                                                default:
                                                    c.fire("short.dialog", {content: i.errorMsg})
                                            }
                                        }
                                    })
                                }
            ...
            var n = this, i = F.context("sign-in").reSignItemId, s = 0;
            t.ajax({
                url: "/ihome/myitem/ucenter", dataType: "jsonp", success: function (a) {
                    t.each(a.property, function (e, n) {
                        n.item_id == i && (s = parseInt(n.number))
                    }), e && t.isFunction(e) && e({itemId: i, itemNum: s, signCardCanUsed: n.signCardCanUsed})
                }
            })
                ...
                try {
                    ...
                    t(i).closest(".ui-datepicker-today").size() ? 0 == F.context("sign-in").isSignIn && (t("#sign-in-btn").click(), t(i).unbind("click")) : e._getRemedyInfo(function (o) {
                        0 == F.context("sign-in").isSignIn ? n = ["<p>\u54ce\u5440\uff0c\u4eca\u5929\u8fd8\u6ca1\u6709\u7b7e\u5230 T_T</p>", "<p>\u8d76\u7d27\u70b9\u51fb\u7b7e\u5230\u5427\u3002</p>"].join("") : 0 == o.signCardCanUsed ? n = "\u8865\u7b7e\u7684\u673a\u4f1a\u5df2\u7ecf\u7528\u5b8c\u4e86T_T...<br />\u4ee5\u540e\u4e00\u5b9a\u8981\u597d\u597d\u73cd\u60dc\u554a\uff01" : o.signCardCanUsed > 0 && 0 == o.itemNum ? n = ["<p>\u60a8\u8fd8\u6ca1\u6709\u8865\u7b7e\u5361\uff0c\u53bb\u5546\u57ce\u5151\u6362\u8865\u7b7e\u5361\u5427\u3002</p>", "<p>", '<a href="/shop/view?id=' + e.cardShopId + '" target="_blank" class="mt-5 btn-22-green">\u5151\u6362\u8865\u7b7e\u5361</a>', "</p>"].join("") : o.signCardCanUsed > 0 && o.itemNum > 0 && o.itemId > 0 && (n = ["<p>\u8fd9\u4e2a\u6708\u8fd8\u6709<strong>" + o.signCardCanUsed + "\u6b21\u8865\u7b7e\u673a\u4f1a</strong>\uff0c\u662f\u5426\u4f7f\u7528\uff1f</p>", '<p style="color:#36A803;">\uff08\u8865\u7b7e\u5361\u53ea\u8865\u7f3a\u6d3b\u8dc3\u5929\uff0c\u4e0d\u8ba1\u5165\u9886\u5956\uff09</p>', "<p>", '<a class="btn-22-green remedy-ok mr-10 mt-10">\u4f7f\u7528</a>', '<a class="btn-22-white remedy-cancel mt-10">\u53d6\u6d88</a>', "</p>"].join("")), e._remedyTip = new a({
                            ...
                            content: n,
                            closebox: !0,
                            position: {my: "left top", at: "left-14 bottom"}
                        }), e._remedyTip.show(), t(e._remedyTip.getTipContainer()).delegate(".remedy-ok", "click", function (n) {
                            try {
                                n.preventDefault();
                                var s = parseInt(i.find(".ui-state-default").html()), a = parseInt(e.month), r = e.year;
                                new d({
                                    params: {cm: 100900, itemid: o.itemId, number: 1, args: t.json.stringify({day: s})},
                                    beforeJump: function () {
                                        ...
                                        n.push([r, a, s].join("/")), F.context("sign-in").signinDays = t.json.stringify(n), e._updateSignIn({noLevelBar: 1})
                                    },
...
define("common:widget/js/logic/mini-editor/mini-editor.js", function (t, e, n) {
    var i = t("common:widget/js/util/tangram/tangram.js"), o = t("common:widget/js/util/event/event.js"), a = t("common:widget/js/ui/base/base.js"), r = a(function () {
        var t = this;
        ...
        init: function () {
            try {
                ...
                t.target = i(t.target), t.container = i("<div/>").attr("id", t.guid + t.name).addClass(t.name).addClass(t.className).appendTo(t.target), i("<textarea/>").attr("id", t.guid + "textarea").appendTo(t.container).val(t.defaultContent), i("<p/>").attr("id", t.guid + "limit").addClass("mini-editor-limit").hide().appendTo(t.container).html(t.maxLength), t._getElement("textarea").on("change keyup", function () {
                    ...
                    t.getContent() == t.defaultContent && t.setContent(""), t.container.css({borderColor: "#95c754"}), t._getElement("textarea").css("color", "#333"), t.fire("focus")
                }).blur(function () {
                    t.container.css("borderColor", "#c7c7c7"), "" == t.getContent() && t.setContent(t.defaultContent), t.fire("blur")
                }), t.on("change", function (e, n) {
                    var a = t.getContent(), r = t.countByte ? i.string(a).getByteLength() : a.length, s = t.maxLength - r, c = t._getElement("limit");
...
define("common:widget/js/logic/file-type/file-type.js", function (e, i, p) {
    var f = e("common:widget/lib/jquery/jquery.js"), l = {
    ...
    p.exports = function (e) {
        ...
        }), {fileClass: p, fileType: i}
    }
});
;
define("common:widget/js/logic/prof-anonymous/prof-anonymous.js", function (e, t, o) {
    var n = e("common:widget/js/util/tangram/tangram.js"), i = "IK_PROFANONYMOUS", s = "IK_PROFANONYMOUS_CLOSE", a = "IK_PROFANONYMOUS_EXPIRE", c = !0, p = null, r = null, u = null;
    o.exports = {
        getCookie: function () {
            ...
            if ("1" == F.context("user").isLogin) {
                var e = (new Date).getTime(), t = n.cookie.get(a);
                if (t) {
            ...
            c = !1, r && clearTimeout(r), p.stop().animate({width: "35px"}, "fast", function () {
                p.find("span").addClass("tip-expand").removeClass("tip-close")
            }), 0 == e && n.cookie.set(s, 1, {path: "/", expires: 15552e6})
        }, expand: function (e) {
            c = !0, p.stop().animate({width: "245px"}, "fast", function () {
                p.find("span").addClass("tip-close").removeClass("tip-expand")
            }), 0 == e && n.cookie.set(s, 0, {path: "/", expires: 15552e6})
        }, initTip: function () {
            try {
                var e = ["\u3010\u7b49\u5f85\u56de\u7b54\u3011", "\u3010\u5df2\u56de\u7b54\u3011"], t = this, o = "/prof/api/questioninfo?t=" + (new Date).getTime();
                n.get(o, function (o) {
                    if (0 == o.errNo && o.data.length > 0) {
                        var i = "<div id='pgctip' class='pgctip'><div class='pgctip-main'><a class='grid'><b>\u5386\u53f2\u63d0\u95ee(#{count})</b><span class='tip-close'></span></a><ul>#{content}</ul></div></div>", s = "<li><a href='/question/#{qid}' target='_blank'>#{index}\uff0e#{qStatus}#{qTitle}</a></li>", a = [];
                        ...
                        var l = n.string(i).format({content: a.join(""), count: o.data.length});
